...
class PasswordResetTests(TestCase):
    ...
    def test_form_inputs(self):
        # the view must contain two inputs: email and csrf
...
class SuccessfulPasswordResetTests(TestCase):
    ...
    def test_redirection(self):
        # a valid form submission should redirect the user to password reset done view
...
class PasswordResertDoneTests(TestCase):
    def setUp(self):
        url = reverse('password_reset_done')
        self.response = self.client.get(url)
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        ...
        # https://github.com/django/django/blob/2.2.1/django/contrib/auth/forms.py#L280
